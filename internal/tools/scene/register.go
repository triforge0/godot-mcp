...
func Register(r *mcp.Registry) {
	...
	toolutil.RegisterWithParams[toolutil.SceneCreateParams](r, toolutil.Spec{
		Name: "scene_create", Description: "Create a new scene and save to disk.", RPC: "scene.create", Level: permission.LevelWrite,
	}, nil)
}
